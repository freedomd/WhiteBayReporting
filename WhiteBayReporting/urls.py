...
urlpatterns = patterns('',
    ...
    url(r'^futureMultiplierProfile/', futureMultiplierView),
    url(r'^accountProfile/', accountView),
    url(r'^groupProfile/', groupView),
    url(r'^tradeManagement/', tradeView),
    url(r'^log/', logView),
    ...
    url(r'^addFutureMultiplier/', addFutureMultiplier),
    url(r'^modFutureMultiplier/', modFutureMultiplier),
