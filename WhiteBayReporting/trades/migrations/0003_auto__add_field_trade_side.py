...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trade.side'
        db.add_column('trades_trade', 'side',
                      self.gf('django.db.models.fields.CharField')(default='SEL', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trade.side'
        db.delete_column('trades_trade', 'side')
